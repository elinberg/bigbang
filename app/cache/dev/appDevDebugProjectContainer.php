...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8b9c00be61554f78d2178e730b26bccda1225f721b3dc0e7d4846b14cb01afbc');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('www-data');
        $a->setPassword(3333);
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('192.168.33.100');
        $instance->setPort(25);
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'elinberg@gmail.com'), array());
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b29687083f08.46386593')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_driver' => 'pdo_pgql',
            'database_host' => 'localhost',
            'database_port' => 5432,
            'database_name' => 'bigbang',
            'database_user' => 'bigbang',
            'database_password' => 'cuoco',
            'mailer_transport' => 'smtp',
            'mailer_host' => '192.168.33.100',
            'mailer_user' => 'www-data',
            'mailer_password' => 3333,
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.33.100',
            'swiftmailer.mailer.default.transport.smtp.username' => 'www-data',
            'swiftmailer.mailer.default.transport.smtp.password' => 3333,
            ...
            'swiftmailer.mailer.default.single_address' => 'elinberg@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'elinberg@gmail.com',
            ),
            ...
            'swiftmailer.single_address' => 'elinberg@gmail.com',
